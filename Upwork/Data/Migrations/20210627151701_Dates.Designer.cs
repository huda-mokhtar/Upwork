...
namespace Upwork.Data.Migrations
{
    ...
    [Migration("20210627151701_Dates")]
    partial class Dates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Upwork.Models.DbModels.Freelancer_Job", b =>
                {
                    ...
                    b.ToTable("Freelancer_Jobs");
                });

            modelBuilder.Entity("Upwork.Models.DbModels.JobQuestions", b =>
                {
                    b.Property<int>("JobsId")
                        .HasColumnType("int");

                    b.Property<int>("ReviewJobQuestionId")
                        .HasColumnType("int");

                    b.HasKey("JobsId", "ReviewJobQuestionId");

                    b.HasIndex("ReviewJobQuestionId");
            ...
            modelBuilder.Entity("Upwork.Models.DbModels.Jobs", b =>
                {
                    ...
                    b.Property<string>("DraftSavedDate")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("JobClosedDate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Upwork.Models.DbModels.ReviewJobQuestion", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Upwork.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Upwork.Models.DbModels.JobQuestions", b =>
                {
                    ...
                    b.HasOne("Upwork.Models.DbModels.ReviewJobQuestion", "ReviewJobQuestion")
                        .WithMany("jobQuestions")
                        .HasForeignKey("ReviewJobQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Jobs");

                    b.Navigation("ReviewJobQuestion");
                });
